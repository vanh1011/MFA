...
import { AnimateTooltip } from "../animate-tooltip/animate-tooltip";
import { RevealAnimate } from "../reveal-animate/reveal-animate";
...
const VARIANT_CLASSES: Record<CopyButtonVariant, string> = {
  ghost:
    "text-neutral-500 hover:bg-primary/10 hover:text-primary dark:text-neutral-400 dark:hover:bg-primary/15 dark:hover:text-primary",
  outline:
    "border border-primary/25 bg-primary/[0.03] text-neutral-800 hover:border-primary/45 hover:bg-primary/10 hover:text-primary dark:border-primary/30 dark:bg-primary/10 dark:text-neutral-100 dark:hover:border-primary/55 dark:hover:bg-primary/15 dark:hover:text-primary",
  solid:
