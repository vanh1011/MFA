...
const socialImage = { url: '/kira-social.png', width: 1200, height: 630, alt: 'Kira Tech — Công cụ lấy OTP 2FA' }
...
export const metadata: Metadata = {
  ...
  other: { image: `${siteUrl}/kira-social.png` },
  openGraph: {
    type: 'website',
    locale: 'vi_VN',
    siteName: 'MFA Tool',
